...
| Source code | Maintain reproducible pipeline, validation, modeling, and test code in Git. | Feasibility, Bronze, Silver ETL, modeling-feature, baseline, ML-selection, and final-evaluation packages, infrastructure smoke tests, and focused Spark tests | IN PROGRESS |
