...
| Source code | Maintain reproducible pipeline, validation, modeling, and test code in Git. | Feasibility scripts, synthetic profiler test, and reproducible infrastructure smoke tests | IN PROGRESS |
...
| README with run instructions | Expand the README with prerequisites, setup, execution, validation, and troubleshooting steps. | Phase 2 configuration, startup, round-trip, restart, and shutdown commands in `README.md` | IN PROGRESS |
