...
| Results and insights | Analyze forecast accuracy by horizon and the incremental value of weather. | Phase 5B validation/test MAE and RMSE for three non-ML baselines; weather A/B experiment remains pending | IN PROGRESS |
...
| Source code | Maintain reproducible pipeline, validation, modeling, and test code in Git. | Feasibility, Bronze, Silver ETL, modeling-feature and baseline packages, infrastructure smoke tests, and focused Spark tests | IN PROGRESS |
