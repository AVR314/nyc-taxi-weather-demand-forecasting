...
| Source code | Maintain reproducible pipeline, validation, modeling, and test code in Git. | Feasibility, Bronze, Silver ETL, modeling-feature packages, infrastructure smoke tests, and focused Spark tests | IN PROGRESS |
...
| README with run instructions | Expand the README with prerequisites, setup, execution, validation, and troubleshooting steps. | Phase 2–5A setup, focused tests, ingestion, Silver ETL, and modeling-feature execution commands in `README.md` | IN PROGRESS |
