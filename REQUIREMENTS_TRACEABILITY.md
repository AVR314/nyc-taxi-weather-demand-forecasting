...
|---|---|---|---|
| Real dataset | Use NYC TLC Yellow Taxi trip records and historical weather data. | Source URLs, ingestion manifest, and reproducible acquisition instructions | NOT STARTED |
...
| Semi-structured or unstructured data | Ingest raw hourly historical weather as JSON. | Bronze JSON objects and documented schema handling | NOT STARTED |
...
| Source code | Maintain reproducible pipeline, validation, modeling, and test code in Git. | Version-controlled source tree and commit history | NOT STARTED |
...
| Dataset link or sample | Provide official dataset links or an intentionally small, documented sample. | README links or sample with provenance | NOT STARTED |
