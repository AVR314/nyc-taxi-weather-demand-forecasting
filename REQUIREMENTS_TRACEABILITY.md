...
| Meaningful transformation | Clean records, report rejections, build Zone × Hour demand, join weather, and later engineer leakage-safe features. | Phase 4 cleaning, 2,295,120-row demand grid, 131,400 weather records, 6,885,360-row validated join, and machine report | IN PROGRESS |
...
| Source code | Maintain reproducible pipeline, validation, modeling, and test code in Git. | Feasibility, Bronze, Spark Silver package, infrastructure smoke tests, and focused Spark tests | IN PROGRESS |
...
| README with run instructions | Expand the README with prerequisites, setup, execution, validation, and troubleshooting steps. | Phase 2–4 setup, focused tests, ingestion, and full Silver execution commands in `README.md` | IN PROGRESS |
